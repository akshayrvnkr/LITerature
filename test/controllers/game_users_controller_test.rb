...
class GameUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create game_user" do
    assert_difference('GameUser.count') do
      post game_users_url, params: { game_user: { cards: @game_user.cards, game_id: @game_user.game_id, last_online: @game_user.last_online, user_id: @game_user.user_id } }
    end
  ...
  test "should update game_user" do
    patch game_user_url(@game_user), params: { game_user: { cards: @game_user.cards, game_id: @game_user.game_id, last_online: @game_user.last_online, user_id: @game_user.user_id } }
